...
export default function Footer() {
    ...
    return (
        <footer className="relative border-t border-zinc-200 dark:border-dark-border bg-zinc-50 dark:bg-dark-base pt-16 lg:pt-24 pb-8 lg:pb-12 overflow-hidden transition-colors duration-500">
            {/* Background Effects */}
            ...
            <div className="container mx-auto px-6 relative z-10 max-w-7xl">
                ...
                >
                    ...
                    >
                        {/* Light: black Factory; Gig strip matches dark PNG over zinc-50 plate (footer bg). Dark: full-color Image. */}
                        <Link href="/" className="inline-block shrink-0">
                            <span className="relative dark:hidden isolate inline-block h-[50px] w-[180px]">
                                {/* Black "factory" part */}
                                <img
                                    src="/assets/GIG.png"
                                    alt="Gigfactory Logo"
                                    className="relative z-0 block h-[50px] w-[180px] object-contain object-left [filter:grayscale(1)_contrast(1.45)_brightness(0)] [clip-path:inset(0_0_0_31%)]"
                                />
                                {/* Green "Gig" part */}
                                <img
                                    src="/assets/GIG.png"
                                    alt=""
                                    aria-hidden="true"
                                    className="absolute left-0 top-0 h-[50px] w-[180px] object-contain object-left [clip-path:inset(0_69%_0_0)]"
                                />
                            </span>
                        ...
                        {/* DESCRIPTION */}
                        <p className="text-zinc-600 dark:text-zinc-400 text-sm lg:text-base leading-relaxed max-w-sm font-medium mb-3">
                        ...
                        <div className="flex flex-col items-start gap-6">
                            ...
                            <a
                                ...
                                target="_blank"
                                className="w-10 h-10 rounded-full border border-zinc-200 dark:border-dark-border bg-zinc-100 dark:bg-dark-base flex items-center justify-center text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:border-[#6EDD4D] hover:bg-[#6EDD4D]/10 transition-all"
                            >
                    ...
                    <div className="md:col-span-12 lg:col-span-9 xl:col-span-9 grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-16 xl:gap-20">
                        <motion.div variants={itemVariants}>
                            ...
                            <ul className="space-y-3 text-zinc-600 dark:text-zinc-400 text-sm lg:text-base font-medium">
                ...
                <motion.div
                    ...
                    className="border-t border-zinc-200 dark:border-dark-border pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] md:text-xs uppercase font-bold tracking-[0.2em] text-zinc-600 dark:text-zinc-500 text-center md:text-left"
                >
                    ...
                    <div className="flex items-center flex-wrap justify-center gap-6 md:gap-10">
                        <Link href="/privacy" className="hover:text-[#6EDD4D] dark:hover:text-white transition-colors">Privacy Policy</Link>
                        <Link href="/terms" className="hover:text-[#6EDD4D] dark:hover:text-white transition-colors">Terms of Service</Link>
                    </div>
                </motion.div>
            </div>
