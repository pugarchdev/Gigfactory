      ...
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          >
           ...
           <Link
            href="/media"
            className={`text-sm font-semibold transition-colors ${isActive('/media') ? 'text-neon-green' : 'text-zinc-500 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white'}`}
          >
            Media
          </Link>
      ...
      {isOpen && (
        <div className="md:hidden absolute top-20 left-0 w-full bg-white dark:bg-black border-b border-zinc-200 dark:border-dark-border p-6 flex flex-col gap-4 shadow-2xl">
          ...
          <Link
            href="/media"
            onClick={() => setIsOpen(false)}
            className={`text-left text-lg font-medium p-3 rounded-lg ${isActive('/media') ? 'bg-zinc-100 dark:bg-dark-surface text-neon-green' : 'text-zinc-600 dark:text-gray-300'}`}
          >
            Media
          </Link>
