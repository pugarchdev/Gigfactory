                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8 items-center">
                    ...
                    <div className="flex flex-col items-center justify-center relative">
                        ...
                        <button
                            ...
                            className="mt-8 px-10 py-4 md:px-12 md:py-5 rounded-xl border border-zinc-700 text-sm md:text-base font-bold uppercase tracking-widest text-white hover:border-[#6EDD4D] hover:text-[#6EDD4D] transition-all duration-300 hover:bg-[#6EDD4D]/5 hover:shadow-[0_0_20px_rgba(110,221,77,0.2)]"
                        >
                            GET IN TOUCH
                        </button>
