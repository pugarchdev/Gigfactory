...
export default function Projects() {
  const allProjects = [
    ...
    { title: "Webworks Data Centre", description: "Tracking and monitoring of project using BIM 4D, Synchro and Primavera P6", images: ["https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=800"], area: "8,00,000 sqft", location: "Navi Mumbai", scope: "BIM - LOD 350, 4D Monitoring and Controls", status: "Ongoing", type: "Data Centre" },
    ...
    { title: "3 Star Hotel in Puri", description: "Ensuring a clash-free building model for construction execution", images: ["https://res.cloudinary.com/deinrj3zm/image/upload/v1776168327/10.Hotel3Star.Puri_k2dfqp.png"], area: "1,00,000 sqft", location: "Puri", scope: "BIM LOD 350 - All Trades + Clash Resolution", status: "Completed", type: "Hospitality" },
