...
const ProjectCard = ({ project }) => (
  <div className="group h-full w-full flex flex-col rounded-2xl border border-zinc-800 bg-zinc-900/30 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:border-[#6EDD4D]/40 hover:scale-[1.01] hover:shadow-[0_0_30px_rgba(110,221,77,0.05)]">
    ...
    <div className="p-6 flex flex-col flex-grow">
      ...
      {/* 4. Scope Box */}
      <div className="mb-6 p-4 rounded-xl bg-zinc-800/50 border border-zinc-700/50 h-[90px] flex flex-col justify-center mt-auto">
...
export default function Projects() {
  const allProjects = [
    ...
    { title: "Webworks Data Centre", description: "Tracking and monitoring of project using BIM 4D, Synchro and Primavera P6", images: ["https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=800",  "https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=800"], area: "8,00,000 sqft", location: "Navi Mumbai", scope: "BIM - LOD 350, 4D Monitoring and Controls", status: "Ongoing", type: "Data Centre" },
    { title: "Mall Project (Kolkata)", description: "BIM support for Edifice Client's interior works in Brookfield Mall", images: ["https://images.unsplash.com/photo-1519567241046-7f570eee3ce6?q=80&w=800", "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=800"], area: "70,000 sqft", location: "Kolkata", scope: "BIM ID - LOD 350, Clash Detection + Resolution", status: "Completed", type: "Retail" },
    ...
    { title: "3 Star Hotel in Puri", description: "Ensuring a clash-free building model for construction execution", images: ["https://res.cloudinary.com/deinrj3zm/image/upload/v1776168327/10.Hotel3Star.Puri_k2dfqp.png",  "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=800"], area: "1,00,000 sqft", location: "Puri", scope: "BIM LOD 350 - All Trades + Clash Resolution", status: "Completed", type: "Hospitality" },
    ...
    { title: "Medical College Project", description: "Preparation of MEPF BOQ for Medical College and hospital", images: [ "https://images.unsplash.com/photo-1516549655169-df83a0774514?q=80&w=800", "https://res.cloudinary.com/deinrj3zm/image/upload/v1776168353/12.Dreamsmith.C_zk0toz.png"], area: "8,00,000 sqft", location: "Kanpur", scope: "MEP BOQ - Tradewise and measurement sheets", status: "Completed", type: "Hospital" },
